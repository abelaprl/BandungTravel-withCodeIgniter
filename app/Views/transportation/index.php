...
<body>
    <nav class="navbar navbar-expand-lg navbar-light bg-light">
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav">
                    <li class="nav-item">
                        <a class="nav-link" href="<?= site_url('/dashboard/' . session()->get('preference')) ?>">Dashboard</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="<?= site_url('transportation') ?>">Transportasi</a>
                    </li>
                    <li class="nav-item">
    ...
    <div class="container mt-4">
        ...
        <div id="routeList">
            <?= view('transportation/route_list', ['routes' => $routes, 'preference' => $preference ?? null]) ?>
        </div>
                ...
                <div class="col-md-4 mb-4">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <a href="<?= site_url('destination/' . $destination['id']) ?>" class="btn btn-info">Detail Destinasi</a>
                        </div>
                    </div>
                </div>
            <?php endforeach; ?>
